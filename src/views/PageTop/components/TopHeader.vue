...
.top-header {
  @apply relative w-full bg-[var(--theme-color)] z-[9999] transition;

  .dock1 {
    @apply relative w-full xl:px-[20px] lg:mx-[20px] overflow-hidden transition ;
    // Responsive
    .inner {
      @apply 2xl:w-[var(--dock-width)] xl:w-full h-[45px] mx-auto my-0;
      // Responsive
      .navbar {
  ...
  .dock2 {
    ...
    .navbar {
      @apply relative h-full xl:mx-[40px] lg:mx-[20px];
      .inner {
        @apply flex 2xl:w-[var(--dock-width)] xl:w-full h-full justify-between items-center mx-auto;
        // Responsive
        // 响应式
        .logo {
        ...
        .nav_main {
          ...
          a {
            @apply relative inline-block xl:text-xl lg:text-lg mx-6;
            // Responsive
            &:after {
